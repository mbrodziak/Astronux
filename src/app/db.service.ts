...
export class DBService {
    ...
    descJupiter: Array<string> = [
        ...
        'Jest znanych 79 księżyców Jowisza. Cztery największe, zwane galileuszowymi, odkrył Galileusz w 1610 roku. Ganimedes, największy z księżyców, ma średnicę większą niż planeta Merkury.',
    ];
    ...
    PLANETS = [
        new Planet('1', 'Merkury', 'skalista', 'mercury.png', 'nieznany', 'znana w starożytności', '87,969 dni', '3,3011 × 1e+23 kg', '7,5 × 1e+7 km²', '100 K - 700 K', '3,70 m/s²', '4,3 km/s', '0,142',  'brak', 'ok. 1e-10 Pa', this.descMerkury),
        new Planet('2', 'Wenus', 'skalista', 'venus.jpg', 'nieznany', 'znana w starożytności', '224,701 dni', '4,867 × 1e+24 kg ', '4,60 × 1e+8 km²', 'średnio 737 K', '8,87 m/s²', '10,36 km/s', '0,698', 'brak', '92 000 hPa', this.descWenus),
        new Planet('3', 'Ziemia', 'skalista', 'earth.jpeg', '', '', '365,256363004 dni', '5,97219 × 1e+24 kg', '510 072 000 km²', '185 K – 331 K', '9,80665 m/s²', '11,19 km/s', '0,434', '1', '1014 hPa', this.descEarth),
        new Planet('4', 'Mars', 'skalista', 'mars.jpg', 'nieznany', 'znana w starożytności', '686,980 dni', '6,4171 × 1e+23 kg', '1,448 × 1e+8 km²', '130 K – 308 K', '3,71 m/s²', '5,03 km/s', '0,170', '2', '400 Pa - 870 Pa', this.descMars),
        new Planet('5', 'Jowisz', 'gazowa', 'jupiter.jpg', 'nieznany', 'znana w starożytności', '4 332,589 dni', '1,89819 × 1e+27 kg', '6,21796 × 1010 km²', '165 K', '24,79 m/s²', '59,5 km/s', '0,538', '79', '', this.descJupiter),
        new Planet('6', 'Saturn', 'gazowa', 'saturn.webp', 'nieznany', 'znana w starożytności', '10 759,22 dni', '5,6834 × 1e+26 kg' , '4,27 × 1e+10 km²', '134 K', '10,44 m/s', '35,5 km/s', '0,499', '82', '', this.descSaturn),
        new Planet('7', 'Uran', 'gazowa', 'uranus.jpg', 'William Herschel', '13 marca 1781', '30 685,4 dni', '8,6813 × 1e+25 kg', '8,084 × 1e+9 km²', '76 K', '8,87 m/s²', 'ucieczki 	21,3 km/s', '0,488', '27', '', this.descUranus),
        new Planet('8', 'Neptun', 'gazowa', 'neptune.jpg', 'Johann Gottfried Galle', '23 września 1846', '60 189 dni', '1,02413 × 1e+26 kg', '7,6183 × 1e+9 km²', '72 K', '11,15 m/s²', '23,5 km/s', '0,442', '14', '', this.descNeptune),
    ];

    MOONS = [
        new Moon('1', 'Księżyc', 'Ziemia', 'moon.jpg', '', '', '27,321661 dni', '7,342 × 1e+22 kg ', '3,793 × 1e+7 km² ', '40 K - 396 K', '1,622 m/s²', '2,38 km/s', '0,12', '-2,5 do -12,9', this.descMoon),
        new Moon('2', 'Deimos', 'Mars', 'deimos.jpg', 'Asaph Hall', '12 sierpnia 1877', '1,26244 dni', '1,476 × 1e+15 kg ', '495,1548 km²', '~233 K', '0,003 m/s²', '5,556 m/s ', '0,068', '12,89', this.descDeimos),
        new Moon('3', 'Fobos', 'Mars', 'phobos.jpg', 'Asaph Hall', '18 sierpnia 1877', ' 0,31891 dni', '1,072 × 1e+16 kg', '1 548,3 km²', '~233 K', '0,0084 m/s² - 0,0019 m/s²', '11,39 m/s', '0,071', '11,4', this.descPhobos),
        new Moon('4', 'Io', 'Jowisz', 'io.jpg', 'Galileo Galilei', '7 stycznia 1610', '1,769 dni', '8,93 × 1e+22 kg', '41 910 000 km²', '90 K - 130 K', '1,796 m/s²', '2,558 km/s', '0,63 ± 0,02', '5,02', this.descIo),
        new Moon('5', 'Europa', 'Jowisz', 'europa.jpg', 'Galileo Galilei', '7 stycznia 1610', '3,551 dni', '4,80 × 1e+22 kg', '3,09 × 1e+7 km²', '50 K - 125 K', '1,314 m/s²', '2,025 km/s', '0,67 ± 0,03 ', '5,29', this.descEuropa),
        new Moon('6', 'Ganimedes', 'Jowisz', 'ganimedes.jpg', 'Galileo Galilei', '7 stycznia 1610', '7,155 dni', '1,4819 × 1e+23 kg', '8,70 × 1e+7 km²', '70 K - 152 K', '1,425 m/s²', '2,74 km/s', '0,43 ± 0,02', '4,61', this.descGanimedes),
        new Moon('7', 'Kallisto', 'Jowisz', 'callisto.jpg', 'Galileo Galilei', '7 stycznia 1610', '16,689 dni ', '(1,07594 ± 0,00014) × 1e+23 kg', '7,30 × 1e+7 km²', '80 K - 165 K', '1,235 m/s²', '2,440 km/s', '0,22', '5,7', this.descCallisto),
        new Moon('8', 'Mimas', 'Saturn', 'mimas.jpg', 'William Herschel', '17 września 1789', '0,942 dni', '(3,7493 ± 0,0031) × 1e+19 kg', '490 000 km² – 500 000 km²', '64 K', '0,0636 m/s²', '0,159 km/s', '0,962 ± 0,004', '13', this.descMimas),
        new Moon('9', 'Enceladus', 'Saturn', 'enceladus.jpg', 'William Herschel', '28 sierpnia 1789', '1,370 dni', '1,080 × 1e+20 kg', '', '32,9 K - 145 K', '0,11 m/s²', '0,239 km/s', '0,99', '12', this.descEnceladus),
        new Moon('10', 'Tetyda', 'Saturn', 'tethys.jpg', 'Giovanni Cassini', '21 marca 1684', '1,888 dni', '6,176 × 1e+20 kg', '', '86 K', '0,145 m/s²', '0,393 km/s ', '1,229 ± 0,005', '10', this.descThetys),
        new Moon('11', 'Dione', 'Saturn', 'dione.jpg', 'Giovanni Cassini', '21 marca 1684', '2,737 dni', '1,096 × 1e+21 kg', '3 964 776,51 km²', '87 K', '0,231 m/s²', '0,510 km/s', '0,998 ± 0,004', '10', this.descDione),
        new Moon('12', 'Tytan', 'Saturn', 'titan.jpg', 'Christiaan Huygens', '25 marca 1655', '15,945 dni', '1,345 × 1e+23 kg', '8,3 × 1e+7 km²', '93,7 K', '1,35 m/s²', '2,639 km/s', '0,22', '8,2 - 9,0', this.descTitan),
        new Moon('13', 'Ariel', 'Uran', 'ariel.jpg', 'William Lassell', '24 października 1851', '2,520 dni', '(1,35 ± 0,12) × 1e+21 kg', '4 211 300 km²', 'ok. 60 K', '0,27 m/s²', '0,56 km/s', '0,39', '14,4', this.descAriel),
        new Moon('14', 'Miranda', 'Uran', 'miranda.jpg', 'Gerard Kuiper', '16 lutego 1948', '1,413 dni', '(6,6 ± 0,7) × 1e+19 kg', '700 000 km²', 'ok. 60 K', '0,079 m/s²', '0,19 km/s', '0,32', '15,5', this.descMiranda),
        new Moon('15', 'Tryton', 'Neptun', 'triton.jpg', 'William Lassell', '10 października 1846', '5,877 dni', '2,14 × 1e+22 kg', '23 018 000 km²', '38 K', '0,779 m/s²', '1,455 km/s', '0,76', '13,47', this.descTriton),
    ];
